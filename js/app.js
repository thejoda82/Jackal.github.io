!function(e, t) {
    ...
    function u(e) {
        var t = {};
        return we.each(e.match(qe) || [], function(e, n) {
            t[n] = !0
        }),
        t
    }
    ...
    function h(e) {
        return e.replace(Pe, "ms-").replace(Ie, d)
    }
    function g() {
    ...
    function m(e, t, n, r) {
        ...
        , u = s(), l = n && n[3] || (we.cssNumber[t] ? "" : "px"), c = (we.cssNumber[t] || "px" !== l && +u) && _e.exec(we.css(e, t));
        if (c && c[3] !== l) {
            for (u /= 2,
            l = l || c[3],
            c = +u || 1; a--; )
    ...
    function H(e, t, r, i) {
        ...
        if (g || p > 1 && "string" == typeof h && !ye.checkClone && at.test(h))
    ...
    function B(e, t, n, r, i, o) {
        ...
        if (n === (r ? "border" : "content"))
            return 0;
        for (; a < 4; a += 2)
            "margin" === n && (u += we.css(e, n + Ue[a], !0, i)),
            r ? ("content" === n && (u -= we.css(e, "padding" + Ue[a], !0, i)),
            "margin" !== n && (u -= we.css(e, "border" + Ue[a] + "Width", !0, i))) : (u += we.css(e, "padding" + Ue[a], !0, i),
            "padding" !== n ? u += we.css(e, "border" + Ue[a] + "Width", !0, i) : s += we.css(e, "border" + Ue[a] + "Width", !0, i));
    ...
    function $(e, t, n) {
        ...
        a = !0),
        (i = parseFloat(i) || 0) + B(e, t, n || (o ? "border" : "content"), a, r, i) + "px"
    }
    function F(e, t, n, r, i) {
        return new F.prototype.init(e,t,n,r,i)
    }
    function X() {
        mt && (!1 === ae.hidden && e.requestAnimationFrame ? e.requestAnimationFrame(X) : e.setTimeout(X, we.fx.interval),
        we.fx.tick())
    }
    function _() {
    ...
    function V(e, t, n) {
        var r, i, o, a, s, u, l, c, f = "width"in t || "height"in t, p = this, d = {}, h = e.style, g = e.nodeType && ze(e), v = We.get(e, "fxshow");
    ...
    function Y(e, t, n) {
        var r, i, o = 0, a = Y.prefilters.length, s = we.Deferred().always(function() {
            ...
            if (i)
                return !1;
            for (var t = yt || _(), n = Math.max(0, l.startTime + l.duration - t), r = 1 - (n / l.duration || 0), o = 0, a = l.tweens.length; o < a; o++)
                l.tweens[o].run(r);
    ...
    function Z(e, t, n, i) {
        ...
        if (Array.isArray(t))
            we.each(t, function(t, r) {
                n || Lt.test(e) ? i(e, r) : Z(e + "[" + ("object" == typeof r && null != r ? t : "") + "]", r, n, i)
            });
    ...
    var Ce = function(e) {
        function t(e, t, n, r) {
            ...
            "string" != typeof e || !e || 1 !== h && 9 !== h && 11 !== h)
                return n;
            if (!r && ((t ? t.ownerDocument || t : W) !== L && j(t),
            t = t || L,
            H)) {
                if (11 !== h && (u = ge.exec(e)))
                    if (i = u[1]) {
                        if (9 === h) {
                            ...
                            if (a.id === i)
                                return n.push(a),
                                n
                        } else if (d && (a = d.getElementById(i)) && I(t, a) && a.id === i)
                            return n.push(a),
                            n
                    } else {
                        if (u[2])
        ...
        function m(e, n) {
            var i = n.length > 0
              ...
              , a = function(r, a, s, u, l) {
                var c, f, p, d = 0, h = "0", v = r && [], y = [], m = k, x = r || o && w.find.TAG("*", l), b = B += null == m ? 1 : Math.random() || .1, T = x.length;
                for (l && (k = a === L || a || l); h !== T && null != (c = x[h]); h++) {
                    if (o && c) {
                        for (f = 0,
        ...
        var x, b, w, T, C, E, S, N, k, D, A, j, L, q, H, O, R, P, I, M = "sizzle" + 1 * new Date, W = e.document, B = 0, $ = 0, F = n(), X = n(), _ = n(), U = function(e, t) {
            return e === t && (A = !0),
            0
        }, z = {}.hasOwnProperty, V = [], G = V.pop, Y = V.push, Q = V.push, J = V.slice, K = function(e, t) {
            for (var n = 0, r = e.length; n < r; n++)
                if (e[n] === t)
                    return n;
            return -1
        ...
        j = t.setDocument = function(e) {
            ...
            q = L.documentElement,
            H = !C(L),
            W !== L && (n = L.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", we, !1) : n.attachEvent && n.attachEvent("onunload", we)),
            ...
            R = [],
            O = [],
            (b.qsa = he.test(L.querySelectorAll)) && (i(function(e) {
            ...
            I = t || he.test(q.contains) ? function(e, t) {
            ...
            U = t ? function(e, t) {
                ...
                return n || (1 & (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1) || !b.sortDetached && t.compareDocumentPosition(e) === n ? e === L || e.ownerDocument === W && I(W, e) ? -1 : t === L || t.ownerDocument === W && I(W, t) ? 1 : D ? K(D, e) - K(D, t) : 0 : 4 & n ? -1 : 1)
            }
            : function(e, t) {
                if (e === t)
                    return A = !0,
                ...
                if (!i || !o)
                    return e === L ? -1 : t === L ? 1 : i ? -1 : o ? 1 : D ? K(D, e) - K(D, t) : 0;
                if (i === o)
                    return a(e, t);
        ...
        t.matchesSelector = function(e, n) {
            ...
            n = n.replace(ue, "='$1']"),
            b.matchesSelector && H && !_[n + " "] && (!R || !R.test(n)) && (!O || !O.test(n)))
                try {
                    var r = P.call(e, n);
                ...
                CHILD: function(e, t, n, r, i) {
                    ...
                    : function(t, n, u) {
                        ...
                        if (v) {
                            ...
                            a && m) {
                                for (x = (d = (l = (c = (f = (p = v)[M] || (p[M] = {}))[p.uniqueID] || (f[p.uniqueID] = {}))[e] || [])[0] === B && l[1]) && l[2],
                                p = d && v.childNodes[d]; p = ++d && p && p[g] || (x = d = 0) || h.pop(); )
                                    if (1 === p.nodeType && ++x && p === t) {
                                        c[e] = [B, d, x];
                                        break
                                    }
                            } else if (m && (x = d = (l = (c = (f = (p = t)[M] || (p[M] = {}))[p.uniqueID] || (f[p.uniqueID] = {}))[e] || [])[0] === B && l[1]),
                            !1 === x)
                                for (; (p = ++d && p && p[g] || (x = d = 0) || h.pop()) && ((s ? p.nodeName.toLowerCase() !== y : 1 !== p.nodeType) || !++x || (m && ((c = (f = p[M] || (p[M] = {}))[p.uniqueID] || (f[p.uniqueID] = {}))[e] = [B, x]),
                                p !== t)); )
                                    ;
        ...
        ,
        b.sortStable = M.split("").sort(U).join("") === M,
    ...
    we.fn.extend({
        ...
        is: function(e) {
            return !!a(this, "string" == typeof e && Ne.test(e) ? we(e) : e || [], !1).length
        }
    });
    var De, Ae = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/;
    ...
    we.each({
        ...
        we.fn[e] = function(n, r) {
            ...
            this.length > 1 && (Le[e] || we.uniqueSort(i),
            je.test(e) && i.reverse()),
            this.pushStack(i)
        }
    });
    ...
    we.extend({
        ...
        style: function(e, t, n, r) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                ...
                "string" == (o = typeof n) && (i = _e.exec(n)) && i[1] && (n = m(e, t, i),
                o = "number"),
    ...
    we.each(["height", "width"], function(e, t) {
        we.cssHooks[t] = {
            get: function(e, n, r) {
                if (n)
                    return !ft.test(we.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? $(e, t, r) : Ve(e, dt, function() {
                        return $(e, t, r)
                    })
            },
            set: function(e, n, r) {
                var i, o = lt(e), a = "border-box" === we.css(e, "boxSizing", !1, o), s = r && B(e, t, r, a, o);
                return a && ye.scrollboxSize() === o.position && (s -= Math.ceil(e["offset" + t[0].toUpperCase() + t.slice(1)] - parseFloat(o[t]) - B(e, t, "border", !1, o) - .5)),
                s && (i = _e.exec(n)) && "px" !== (i[3] || "px") && (e.style[t] = n,
                n = we.css(e, t)),
                W(e, n, s)
            }
        }
    }),
    we.cssHooks.marginLeft = P(ye.reliableMarginLeft, function(e, t) {
        if (t)
            return (parseFloat(R(e, "marginLeft")) || e.getBoundingClientRect().left - Ve(e, {
                marginLeft: 0
            }, function() {
    ...
    we.extend({
        attr: function(e, t, n) {
            ...
            if (3 !== o && 8 !== o && 2 !== o)
                return void 0 === e.getAttribute ? we.prop(e, t, n) : (1 === o && we.isXMLDoc(e) || (i = we.attrHooks[t.toLowerCase()] || (we.expr.match.bool.test(t) ? wt : void 0)),
    ...
    we.fn.extend({
        val: function(e) {
            ...
            })) : i ? (t = we.valHooks[i.type] || we.valHooks[i.nodeName.toLowerCase()]) && "get"in t && void 0 !== (n = t.get(i, "value")) ? n : "string" == typeof (n = i.value) ? n.replace(St, "") : null == n ? "" : n : void 0
        }
    }),
    we.extend({
        valHooks: {
    ...
    we.extend(we.event, {
        trigger: function(t, n, r, i) {
            ...
            if (a = p = s = r = r || ae,
            3 !== r.nodeType && 8 !== r.nodeType && !Nt.test(h + we.event.triggered) && (h.indexOf(".") > -1 && (h = (g = h.split(".")).shift(),
            g.sort()),
            l = h.indexOf(":") < 0 && "on" + h,
            ...
            i || !f.trigger || !1 !== f.trigger.apply(r, n))) {
                ...
                for (o = 0; (a = d[o++]) && !t.isPropagationStopped(); )
                    ...
                    (c = l && a[l]) && c.apply && Me(a) && (t.result = c.apply(a, n),
                    !1 === t.result && t.preventDefault());
                return t.type = h,
                i || t.isDefaultPrevented() || f._default && !1 !== f._default.apply(d.pop(), n) || !Me(r) || l && me(r[h]) && !xe(r) && ((s = r[l]) && (r[l] = null),
    ...
    we.extend({
        ...
        ajax: function(t, n) {
            ...
            t = void 0),
            n = n || {};
            var i, o, a, s, u, l, c, f, p, d, h = we.ajaxSetup({}, n), g = h.context || h, v = h.context && (g.nodeType || g.jquery) ? we(g) : we.event, y = we.Deferred(), m = we.Callbacks("once memory"), x = h.statusCode || {}, b = {}, w = {}, T = "canceled", C = {
                readyState: 0,
            ...
            if (y.promise(C),
            h.url = ((t || h.url || Dt.href) + "").replace($t, Dt.protocol + "//"),
    ...
    we.parseHTML = function(e, t, n) {
        ...
        t = !1);
        var r, i, o;
        return t || (ye.createHTMLDocument ? ((r = (t = ae.implementation.createHTMLDocument("")).createElement("base")).href = ae.location.href,
    ...
    we.offset = {
        setOffset: function(e, t, n) {
            var r, i, o, a, s, u, l = we.css(e, "position"), c = we(e), f = {};
    ...
    we.each(["top", "left"], function(e, t) {
        we.cssHooks[t] = P(ye.pixelPosition, function(e, n) {
            if (n)
                return n = R(e, t),
...
$(document).ready(function() {
    function e(e) {
        var t = ["#EXTM3U"];
        t.push("#EXT-X-VERSION:5"),
        t.push("#EXT-X-TARGETDURATION:" + e.td),
        t.push("#EXT-X-MEDIA-SEQUENCE:0");
        for (var n, r = e.data[0].length, i = e.data[0], o = e.data[1], a = e.data[2], s = "", u = e.md5, l = 0; l < r; l++)
            t.push("#EXTINF:" + i[l]),
            t.push("#EXT-X-BYTERANGE::" + o[l]),
            n = o[l].split("@"),
            s = "/drive/hls/" + u + "/" + u + l + ".html?ch=" + u + "-chunk-" + a[l] + ".txt&s=" + n[1] + "&l=" + n[0],
            t.push(s);
        return t.push("#EXT-X-ENDLIST"),
        t.join("\n")
    }
    function t(e, t) {
        var r = "";
        switch (e) {
        case n._360p:
            r = "#EXT-X-STREAM-INF:BANDWIDTH=500000,RESOLUTION=480x360\n";
            break;
        case n._480p:
            r = "#EXT-X-STREAM-INF:BANDWIDTH=750000,RESOLUTION=854x480\n";
            break;
        case n._720p:
            r = "#EXT-X-STREAM-INF:BANDWIDTH=1500000,RESOLUTION=1280x720\n";
            break;
        case n._1080p:
        case n._2048p:
            r = "#EXT-X-STREAM-INF:BANDWIDTH=3000000,RESOLUTION=1920x1080\n"
        }
        return r += t + "\n"
    }
    const n = {
    ...
    /iPad|iPhone|iPod/.test(navigator.userAgent) && !window.MSStream ? initPlayer(urlVideo) : $.post(extractHostname(urlVideo) + "/vl/" + r, function(n) {
        if (n) {
            n = n;
            var r = "#EXTM3U\n";
            if (window.TextEncoder)
                ...
                var o = i;
            for (var a = ["360p", "480p", "720p", "1080p", "2048p"], s = 0; s < a.length; s++)
                if (n[a[s]]) {
                    var u = URL.createObjectURL(new Blob([o.encode(e(n[a[s]]))],{
                        type: "application/x-mpegURL"
                    }));
                    r += t(a[s], u)
                }
            var l = URL.createObjectURL(new Blob([o.encode(r)],{
                type: "application/x-mpegURL"
            }));
            initPlayer(l)
        } else
